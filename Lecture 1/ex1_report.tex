...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{covs =}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{)}
...
\NormalTok{    covs[i] =}\StringTok{ }\KeywordTok{cov}\NormalTok{(x,y)}
\NormalTok{    mean_X[i] =}\StringTok{ }\KeywordTok{mean}\NormalTok{(x)}
\NormalTok{    mean_Y[i] =}\StringTok{ }\KeywordTok{mean}\NormalTok{(y)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
