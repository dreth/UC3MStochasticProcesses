...
Our function seems to oscillate between a nearly fully decoded message where b is mapped to p and the opposite.
...
An M/M/c queue is a stochastic process whose state space is the set {0, 1, 2, 3, ...} where the value corresponds to the number of customers in the system, including any currently in service. [@wiki1]
...
for (i in 1:10) {
    ...
    for (i in 0:99) {
        ...
        # checking all exit times mayores al arrival time of the person number number_of_customers - i
