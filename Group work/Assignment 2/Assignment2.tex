...
\CommentTok{#> 20475  20799  1.359935  vjvj xqn wcck pcnjfgwcp qn q fcbhysighk gk quu...}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{last_arrival_time <-}\StringTok{ }\NormalTok{times}\OperatorTok{$}\NormalTok{arrival[}\KeywordTok{length}\NormalTok{(times}\OperatorTok{$}\NormalTok{arrival)]}
\KeywordTok{sum}\NormalTok{(times}\OperatorTok{$}\NormalTok{exit }\OperatorTok{>}\StringTok{ }\NormalTok{last_arrival_time)}
\CommentTok{#> [1] 5}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nb.pe=}\KeywordTok{numeric}\NormalTok{(}\DataTypeTok{length=}\KeywordTok{length}\NormalTok{(t))}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(times}\OperatorTok{$}\NormalTok{service))\{}
\NormalTok{  nb.pe[i]=}\KeywordTok{length}\NormalTok{(}\KeywordTok{which}\NormalTok{(times}\OperatorTok{$}\NormalTok{arrival}\OperatorTok{<}\NormalTok{times}\OperatorTok{$}\NormalTok{service[i]}\OperatorTok{&}\NormalTok{times}\OperatorTok{$}\NormalTok{exit}\OperatorTok{>}\NormalTok{times}\OperatorTok{$}\NormalTok{service[i]))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
