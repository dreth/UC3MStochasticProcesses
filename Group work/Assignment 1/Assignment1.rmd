...
Zero has period 1, so all states have period 1 and therefore the MC aperiodic.

**write 3 in latex**

**write expected return time to 0**

$\pi_{i} = \frac{1}{p} * (1-p)^{i}$ for all $i \in \mathbb{N} \cup \{0\}$
